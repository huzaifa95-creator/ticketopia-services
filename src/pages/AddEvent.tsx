...
const AddEvent = () => {
  ...
  const onSubmit = async (values: EventFormValues) => {
    ...
    try {
      ...
      if (!token) {
        navigate("/login?redirect=/add-event");
        return;
      }
        ...
        <div className="max-w-3xl mx-auto">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Create a new event for others to discover and book
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...form}>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Technology, Music, Business..." {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="10:00 AM - 5:00 PM" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Convention Center, City" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
